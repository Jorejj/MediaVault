-- MediaVault Supabase one-shot setup (FINAL)
-- Use this single file in Supabase SQL Editor for new setups.
-- If you already ran previous scripts, this file is still safe due to IF NOT EXISTS / DROP IF EXISTS usage.
