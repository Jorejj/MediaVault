...
public class MediaVaultWidgetProvider extends AppWidgetProvider {
    ...
    private static void updateWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            views.setTextViewText(R.id.widget_progress_text, progress + " / " + total);
            views.setProgressBar(R.id.widget_progress_bar, Math.max(total, 1), Math.min(progress, total), false);
        } else {
