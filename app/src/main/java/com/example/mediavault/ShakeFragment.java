...
public class ShakeFragment extends Fragment {
    ...
    private void handleShake() {
        Cursor cursor = dbHelper.getRandomPlanningMedia();
        if (cursor != null && cursor.moveToFirst()) {
            ...
            tvType.setText(type + " • " + (genre != null ? genre : "General"));
            ...
            if (imagePath != null && !imagePath.isEmpty()) {
                ...
                if (file.exists()) {
                    ...
                    Glide.with(this).load(imagePath).placeholder(R.drawable.app_icon).into(ivImage);
                }
            } else {
                ivImage.setImageResource(R.drawable.app_icon);
            }
